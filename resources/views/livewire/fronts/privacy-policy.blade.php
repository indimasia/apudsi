<div class="px-6 py-8 mx-auto">
    ...
    <p>This privacy policy applies to the Halal Style app (hereby referred to as "Application") for mobile devices that
        was created by Satulink (hereby referred to as "Service Provider") as a Free service. This service is intended
    ...
    <p>For a better experience, while using the Application, the Service Provider may require you to provide us with
        certain personally identifiable information, including but not limited to Email, userId, gender. The information
    ...
    <p>The Service Provider will retain User Provided data for as long as you use the Application and for a reasonable
        ...
        please contact them at biz@satulink.co.id and they will respond in a reasonable time.</p>
    ...
    <div><br>
        <p>The Application does not address anyone under the age of 13. The Service Provider does not knowingly collect
            ...
            provided us with personal information, please contact the Service Provider (biz@satulink.co.id) so that they
    ...
    <p>This privacy policy is effective as of 2024-05-09</p><br><strong>Your Consent</strong>
    ...
    <p>If you have any questions regarding privacy while using the Application, or have questions about the practices,
        please contact the Service Provider via email at biz@satulink.co.id.</p>
    <hr>
